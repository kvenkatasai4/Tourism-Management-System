			    	...
			    	<div class="row">
			    		<div class="col-sm-12">
			    			<form>
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" value="<%=session.getAttribute("transportType1") %>" type="text" id="transportType" name="transportType" readonly>
			    				</div>
			    				</div>
			    				</div>
			    				<div class="col-sm-12">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" value="<%=session.getAttribute("vehicleType1") %>" type="text" id="vehicleType" name="vehicleType" readonly>
			    				</div>
			    				</div>
			    				</div>
			    				<div class="col-sm-12">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" value="<%=session.getAttribute("vehicleName1") %>" type="text" id="vehicleName" name="vehicleName" readonly>
			    				</div>
			    				</div>
			    				</div>
			    				<div class="col-sm-12">
			    				...
			    				<div class="col-sm-4">
			    				<div class="form-group">
			    					<input class="form-control" value="<%=session.getAttribute("vehicleCost1") %>" type="text" id="vehicleCost" name="vehicleCost" readonly>
			    				</div>
			    				</div>
			    				</div>
			    				<div class="col-sm-12">
